<?php
	...
	function loginUserCheck($username, $password) {
	  ...
	  $mysqli = $db->getConnection();
		...
		$stmt = $mysqli->prepare("SELECT id, password, userName, roles_id, gender_id, apps_countries_id, profile_img, email FROM User");

		$stmt->execute();
		$stmt->bind_result($id, $pass, $userName, $User_roles_id, $User_gender_id, $User_apps_countries_id, $profile_img, $email);
